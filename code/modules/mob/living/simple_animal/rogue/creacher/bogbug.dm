//Got this one resprited and remade. I'd rather make a literal reference to CEV: Eris with a resprite rather than use the sprites from a  Russian C-Word Z*pe Game.
//Just to warn you all. This is more of a praise towards my favourite server for more than a year than anything.
