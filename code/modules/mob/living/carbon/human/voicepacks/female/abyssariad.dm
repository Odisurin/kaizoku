/datum/voicepack/female/abyssariad/get_sound(soundin, modifiers)
	...
	if(!used)
		switch(soundin)
			...
			if("scream")
				used = list('sound/vo/female/abyssariad/angry.ogg','sound/vo/female/abyssariad/angry2.ogg','sound/vo/female/elf/scream (3).ogg','sound/vo/female/elf/scream (4).ogg')
			if("praise")
