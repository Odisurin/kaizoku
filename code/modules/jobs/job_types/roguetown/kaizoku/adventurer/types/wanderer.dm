...
/datum/job/roguetown/kaizoku/wanderer
	title = "Wanderer"
	flag = ADVENTURER
	...
	total_positions = 0
	spawn_positions = 6
	allowed_races = list("Kitsune",
	"Tengu",
	"Oni",
	"Kappa")
	tutorial = "Usually hero of battles and stalwart soldiers, the wanderers bear the scars of countless battles and now travel light in search of their own destiny. The wind carries the whispers of their past as fate forces them to drift from place to place. Many call them Vagabonds, other many consider them the seed of heroism. J.R.R. Tolkien: 'Not all those who wander are lost.'"
...
/datum/job/roguetown/kaizoku/wanderer/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(L)
