...
#define ALL_RACES_LIST		list("human", "dwarf", "elf", "tiefling", "aasimar", "abyssariad")

#define ALL_RACES_LIST_NAMES		list("Humen", "Humen", "Half-Elf", "Elf", "Elf", "Dwarf","Dwarf","Tiefling", "Aasimar", "Kitsune", "Tengu", "Oni", "Kappa")
