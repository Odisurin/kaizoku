...
// Druid
/obj/effect/proc_holder/spell/targeted/blesscropz
	name = "Bless Crops"
	range = 5
...
/obj/effect/proc_holder/spell/targeted/blesscropz/cast(list/targets,mob/user = usr)
...
/obj/effect/proc_holder/spell/targeted/beasttamez
	name = "Tame Beast"
	range = 5
...
/obj/effect/proc_holder/spell/targeted/beasttamez/cast(list/targets,mob/user = usr)
...
/obj/effect/proc_holder/spell/targeted/conjure_glowshroomz
...
/obj/effect/proc_holder/spell/targeted/conjure_glowshroomz/cast(list/targets,mob/user = usr)
	var/turf/T = user.loc
